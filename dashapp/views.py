...
def previsao():
    ...
    if request.method == 'POST':
        ...
        modelo = joblib.load(r'C:\Users\joaod\Documents\GitHub\Data-Science-Project\modelo.joblib')
        ...
        try:
            ...
            return render_template('previsao.html', valor_predito=f'O valor previsto da propriedade é R$ {valor_predito:.2f}')  # Exibe o valor previsto com duas casas decimais
        except Exception as e:
            return render_template('previsao.html', error=f'Ocorreu um erro ao prever o valor da propriedade: {e}')  # Exibe uma mensagem de erro se ocorrer algum problema
    else:
